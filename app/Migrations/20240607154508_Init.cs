    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SheduleDaySubjects", x => new { x.SheduleDayId, x.SubjectId });
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 6, 7, 0, 0, 0, 0, DateTimeKind.Local), (byte)1, 1 },
                    { 2, new DateTime(2024, 6, 7, 0, 0, 0, 0, DateTimeKind.Local), (byte)2, 2 },
                    { 3, new DateTime(2024, 6, 7, 0, 0, 0, 0, DateTimeKind.Local), (byte)2, 4 }
                });
